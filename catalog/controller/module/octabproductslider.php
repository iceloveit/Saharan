...
class ControllerModuleOctabproductslider extends Controller {
	public function index($setting) {
		...
		$this->load->model('module/mostviewed');
		...
		if($setting['types']) {
			foreach($setting['types'] as $type) {
				...
				if($type == "mostviewed") {
					...
					$mostviewed_products = $this->model_module_mostviewed->getMostViewedProducts($setting['limit']);
		...
		if ($data['productTabslider']) {
			return $this->load->view('module/octabproductslider.tpl', $data);
		}
	}
