...
class ControllerModuleOcsearchcategory extends Controller {
    ...
    public function index() {
        ...
        return $this->load->view('module/ocsearchcategory/ocsearchcategory.tpl', $data);
    }
    ...
    public function ajaxSearch() {
        ...
        if(($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $json['result_html'] = $this->load->view('module/ocsearchcategory/searchajaxresult.tpl', $data);
