...
<footer>
  <div class="container">
	...
	<div class="col-sm-6 col-md-3 contact-info">
		<h3 class="footer-title"><?php echo $text_contact?></h3>
		<ul class="list-unstyled">
	...
	<div class="col-sm-12 col-md-9 text-powered-container">
		    <p class="text-powered"><?php echo $powered; ?></p>
	</div>
	<div class="col-sm-12 col-md-3 follow-us-container">
