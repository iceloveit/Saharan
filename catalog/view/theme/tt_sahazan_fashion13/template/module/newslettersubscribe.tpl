...
<div class="newletter-subscribe">
	<div id="boxes-normal" class="newletter-container">
		<div style="" id="dialog-normal" class="window">
			<div class="box">
				<div class="newletter-title"><h3><?php echo $heading_title; ?></h3></div>
					<div class="box-content newleter-content">
						<div class="des-testimonial">
							<?php //echo $newletter_des_normal; ?>
						</div>
						<h3 class="footer-title"><?php echo $newletter_lable2; ?></h3>
						<div id="frm_subscribe-normal">
							<form name="subscribe" id="subscribe-normal">
								...
								<input placeholder="<?php echo $entry_email; ?>" type="hidden" value="" name="subscribe_name" id="subscribe_name-normal" />
