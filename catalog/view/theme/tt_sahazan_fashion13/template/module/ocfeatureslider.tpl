<div class="featured-module quickview-added">
<div class="container">
  ...
  <div class="featured-product-slider quickview-added">
    <?php if($products): ?>
            ...
            <div class="product-layout product-grid">
			  <div class="product-thumb layout7 layout7s">
				  <div class="image">
				...
				<div class="product-inner">
				  ...
				  <div class="product-intro">
						<?php if($config_slide['f_show_addtocart']) { ?>
							<a class="btn-cart2" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-basket"></i><span class="button"><?php echo $button_cart; ?></span></a>
						<?php } ?>
