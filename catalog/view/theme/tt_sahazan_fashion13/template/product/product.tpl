...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h2 class="module-title"><?php echo $text_related; ?></h2>
      <!-- <div class="row"> -->
      <div class="related-product">
	  <?php foreach ($products as $product) { ?>
		<div class="product-layout product-grid">
			<div class="product-thumb layout7">
			  <div class="image">
				  ...
				  <div class="actions-link">
							<a data-toggle="tooltip" title="<?php echo $button_wishlist; ?>"  onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-star" aria-hidden="true"></i></a>
				...
				<div class="product-inner">
				  ...
				  <a class="btn-cart2" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span><i class="fa fa-shopping-cart"></i></a>
