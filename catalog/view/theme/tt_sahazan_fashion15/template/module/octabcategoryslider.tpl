...
<?php
	...
	if(!$row) {$row=1;}
?>
<div class="product-tabs-category-container-slider owl-style2 <?php echo $cateogry_alias;?>">
<div class="container">
				...
				<div class="product-inner">
				  ...
				  <div class="product-intro">
							...
							<?php if($config_slide['tab_cate_show_addtocart']) { ?>
								<a class="btn-cart2" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-basket"></i></a>
							<?php } ?>
