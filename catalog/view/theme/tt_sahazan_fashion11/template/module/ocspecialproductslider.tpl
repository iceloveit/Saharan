<div class="speical-module">
<div class="module-title module-title5">
    ...
    <div class="product-layout product-grid">
							  <div class="product-thumb layout6">
								  ...
								  <?php if ($product['thumb']) { ?>
									...
									<?php if($product['rotator_image']){ ?><img src="image/catalog/loading.gif" class="img-r lazy" data-original="<?php echo $product['rotator_image']; ?>" alt="<?php echo $product['name']; ?>" /><?php } ?>
								  <?php } else { ?>
								  ...
								  <div class="actions-link">
										<?php if($config_slide['f_show_addtocart']) { ?>
											...
											<?php } ?>
											<a data-toggle="tooltip" title="<?php echo $button_compare; ?>"  onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-random"></i></a>											
											<a data-toggle="tooltip" title="<?php echo $button_wishlist; ?>"  onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o"></i></a>
										</div>
