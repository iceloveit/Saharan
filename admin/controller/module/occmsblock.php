<?php
class ControllerModuleOccmsblock extends Controller {
	private $error = array();
	...
	public function index() {
		$this->load->language('module/occmsblock');
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('module/occmsblock', 'token=' . $this->session->data['token'], 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('module/occmsblock', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);			
		}

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('module/occmsblock', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('module/occmsblock', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		
		$data['cms_link'] = $this->url->link('module/occmsblock/cmslist', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/occmsblock/config.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/occmsblock')) {
	...
	public function cmslist() {
		$this->language->load('module/occmsblock');
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('module/occmsblock/cmslist', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('module/occmsblock', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['insert'] = $this->url->link('module/occmsblock/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('module/occmsblock/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		if($results) {
			foreach ($results as $result) {
				...
				$action[] = array(
					...
					'href' => $this->url->link('module/occmsblock/update', 'token=' . $this->session->data['token'] . '&cmsblock_id=' . $result['cmsblock_id'] . $url, 'SSL')
				);
		...
		$pagination->url = $this->url->link('module/occmsblock/cmslist', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('module/occmsblock/cmsblock_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['cmsblock_id'])) {
			$data['action'] = $this->url->link('module/occmsblock/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('module/occmsblock/update', 'token=' . $this->session->data['token'] . '&cmsblock_id=' . $this->request->get['cmsblock_id'] . $url, 'SSL');
		}
		
		$data['cancel'] = $this->url->link('module/occmsblock', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('module/occmsblock/cmsblock_form.tpl', $data));
	}
