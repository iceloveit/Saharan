...
class ControllerModuleOcblog extends Controller {
...
//            $this->model_setting_setting->editSettingValue('ocblog', 'ocblog_meta_title', $this->request->post['ocblog_meta_title']);
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/ocblog', 'token=' . $this->session->data['token'], 'SSL'),
        );

        if (isset($this->request->get['module_id'])) {
            $data['list_action'] = $this->url->link('blog/articlelist', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
        } else {
            $data['list_action'] = $this->url->link('blog/articlelist', 'token=' . $this->session->data['token'], 'SSL');
        }
		$data['action'] = $this->url->link('module/ocblog', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');
		
		if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$module_info = $this->model_extension_module->getModule($this->request->get['module_id']);
            $data['action'] = $this->url->link('module/ocblog', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
        ...
        $this->response->setOutput($this->load->view('module/ocblog', $data));
    }
    

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'module/ocblog')) {
