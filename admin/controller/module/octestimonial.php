<?php
class ControllerModuleOctestimonial extends Controller {
	private $error = array();
	...
	public function index() {
		$this->load->language('module/octestimonial');
		...
		$data['action'] = $this->url->link('module/octestimonial', 'token=' . $this->session->data['token'], 'SSL');
		$data['cancel'] = $this->url->link('extension/module', 'token=' . $this->session->data['token'], 'SSL');

		if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$module_info = $this->model_extension_module->getModule($this->request->get['module_id']);
			$data['action'] = $this->url->link('module/octestimonial', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL');
		}
		...
		if (isset($this->request->post['pagination'])) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('module/octestimonial', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' / '
   		);
        ...
        $this->response->setOutput($this->load->view('module/octestimonial.tpl', $data));
	}
	
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/octestimonial')) {
