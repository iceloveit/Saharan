...
class ControllerModuleOcslideshow extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('module/ocslideshow/form', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['copy'] = $this->url->link('module/ocslideshow/copy', 'token=' . $this->session->data['token'] . $url, 'SSL');
