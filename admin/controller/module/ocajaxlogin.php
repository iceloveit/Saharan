<?php
class ControllerModuleOcajaxlogin extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('module/ocajaxlogin');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->model_setting_setting->editSetting('ocajaxlogin', $post_data);

            // To display the success text on data save
            $this->session->data['success'] = $this->language->get('text_success');

            // Redirect to the Module Listing
            $this->response->redirect($this->url->link('module/ocajaxlogin', 'token=' . $this->session->data['token'], 'SSL'));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/ocajaxlogin', 'token=' . $this->session->data['token'], 'SSL')
        );

        $data['action'] = $this->url->link('module/ocajaxlogin', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('module/ocajaxlogin.tpl', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'module/ocajaxlogin')) {
