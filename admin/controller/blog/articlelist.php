...
class ControllerBlogArticlelist extends Controller
{
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('blog/articlelist', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    public function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('module/ocblog', 'token=' . $this->session->data['token'] . $url, 'SSL'),
        );

        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('blog/articlelist', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );

        $data['add'] = $this->url->link('blog/articlelist/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['copy'] = $this->url->link('blog/articlelist/copy', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['delete'] = $this->url->link('blog/articlelist/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        foreach ($results as $result) {
            $data['articles_list'][] = array(
                ...
                'edit'       => $this->url->link('blog/articlelist/edit', 'token=' . $this->session->data['token'] . '&article_list_id=' . $result['article_list_id'] . $url, 'SSL')
            );
        }
        ...
        $pagination->url = $this->url->link('blog/articlelist', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
    ...
    public function getForm() {
        ...
        if (!isset($this->request->get['article_list_id'])) {
            $data['action'] = $this->url->link('blog/articlelist/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
        } else {
            $data['action'] = $this->url->link('blog/articlelist/edit', 'token=' . $this->session->data['token'] . '&article_list_id=' . $this->request->get['article_list_id'] . $url, 'SSL');
        }

        $data['cancel'] = $this->url->link('blog/articlelist', 'token=' . $this->session->data['token'] . $url, 'SSL');
